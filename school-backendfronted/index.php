    ...
    <main class="main">
        ...
        <section class="hero">
            <div class="card hero-card">
                ...
                <p>
                     test du pipeline dans le raport Supervise les établissements, organise les classes, suit les étudiants, gère les matières et pilote les notes depuis une interface unique.
